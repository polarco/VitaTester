[Home](../README.md) · [Português](USAGE.pt-BR.md)

# User guide — VitaTester 1.5.0
...
fault. See the [physical test procedure](VALIDATION.md) before prolonged use.
...
See [Scanner design and limits](SCANNER.md).
...
[Log format and examples](LOG.md) describe schema 1 JSON Lines. The dedicated
